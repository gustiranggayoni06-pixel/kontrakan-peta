// 1. DATABASE STATIS - Menggunakan Koordinat Akurat Anda & Harga Terbaru
const dataKontrakan = [
    {
        id: 1,
...
// Kamera peta langsung dikunci ke koordinat asli dengan tingkat zoom dekat (16)
const map = L.map('map').setView([dataKontrakan[0].lat, dataKontrakan[0].lng], 16);

// Memuat ubin peta resmi OpenStreetMap
...
containerDaftar.innerHTML = ''; // Membersihkan sisa data lama jika ada
...
dataKontrakan.forEach(unit => {
    ...
    // B. Menempelkan Kartu Informasi Kontrakan di bawah peta
    const kartuHtml = `
...
// 5. PROSES FORM LANGSUNG KE WHATSAPP PEMILIK
